...
<!-- Navbar -->
<nav class="bg-navy-blue sticky lg:static">
    <div class="text-light-gray py-5 lg:py-3 container mx-auto px-12 grid grid-cols-1 lg:grid-cols-[200px_minmax(300px,1fr)_300px] items-center">
        <div class="menu-button flex justify-between items-center">
            ...
            <button id="menu-open" class="hamburger-open flex lg:hidden hover:bg-light-navy rounded-full p-3" onclick="toggleMenu()">
            ...
            <button id="menu-close" class="hamburger-close hidden lg:hidden hover:bg-light-navy rounded-full p-3" onclick="toggleMenu()">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     stroke="currentColor" class="size-6">
        ...
        <!--Menu-->
        <div id="menu" class="hidden pt-5 lg:flex justify-center lg:py-4 lg:pr-6">
            <nav>
        ...
        <div class="hidden lg:flex" id="search-mobile">
            ...
            <div id="nav-icons" class="nav-icons hidden lg:flex lg:items-center">
